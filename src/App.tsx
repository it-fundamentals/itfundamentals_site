  ...
  return (
    <HashRouter>
      <div className="relative min-h-screen bg-[#070a12] text-white selection:bg-red-500/30">
        ...
        <header className="fixed top-4 left-1/2 -translate-x-1/2 z-[100] w-full max-w-6xl px-3 sm:px-4">
          <div className="bg-[#0a0e18]/60 backdrop-blur-xl border border-white/10 rounded-2xl p-2 shadow-2xl">
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2 border-l border-white/10 pl-2 flex-shrink-0">
                {LANGUAGES.map((l) => (
                  <button
                    key={l.code}
                  ...
                  >
                    ...
                    <span className="text-xs font-black tracking-widest hidden sm:inline">{l.name}</span>
                  </button>
                ))}
              </div>
            </div>
        ...
        <main className="relative z-10">
          <AnimatePresence mode="wait">
            <Routes>
              ...
              <Route
                path="/contact"
                element={<PageTemplate title={dict.page_contact_title} body={dict.page_contact_body} />}
              />
