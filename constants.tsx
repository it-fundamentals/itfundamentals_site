...
export const I18N: Record<Language, Dictionary> = {
  en: {
    ...
    page_portal_body: "This page is reserved for the client portal. It will host secure access to support requests, service updates, and shared documentation.",
    page_about_title: "About us",
    page_about_body: "We help micro and small businesses build a stable, secure Microsoft 365 foundation. The focus is practical delivery, predictable outcomes, and a clean path to modern security and automation.",
    page_contact_title: "Contact us",
    page_contact_body: "If you would like to talk through your current setup and what a safe baseline looks like, reach out and we will respond with next steps.",
    stages: {
      "stage-basecamp": {
        id: "stage-basecamp",
        chip: "BASE CAMP",
      ...
      "stage-ready": {
        ...
        items: [
          "Centralised data and clean permissions",
          "Auditable access and safer sharing",
          "AI as a value add, not a risk"
        ],
        icons: ["⚙️", "✨", "🧊"],
  ...
  de: {
    ...
    page_portal_body: "Diese Seite ist für das Kundenportal reserviert. Sie wird sicheren Zugriff auf Support-Anfragen, Service-Updates und geteilte Dokumentation bieten.",
    page_about_title: "Über uns",
    page_about_body: "Wir helfen Klein- und Kleinstunternehmen, eine stabile und sichere Microsoft 365-Grundlage aufzubauen. Der Fokus liegt auf pragmatischer Umsetzung, planbaren Ergebnissen und einem sauberen Weg zu moderner Sicherheit und Automatisierung.",
    page_contact_title: "Kontakt",
    page_contact_body: "Wenn du deine aktuelle Umgebung besprechen möchtest und wissen willst, wie eine sichere Basis aussieht, melde dich. Wir antworten mit konkreten nächsten Schritten.",
    stages: {
      "stage-basecamp": {
        id: "stage-basecamp",
        chip: "BASISLAGER",
      ...
      "stage-transition": {
        ...
        items: [
          "E-Mail, Kalender und Dateien migrieren",
          "Teams, SharePoint und OneDrive einrichten",
          "Minimale Unterbrechung, sauberer Cutover"
        ],
        icons: ["✉️", "📁", "👥"],
      ...
      "stage-secure": {
        ...
        items: [
          ...
          "Baseline-Richtlinien anwenden",
          "Sicheres Teilen und Berechtigungen"
        ],
        icons: ["🔐", "📜", "🧷"],
      ...
      "stage-ready": {
        ...
        items: [
          "Zentralisierte Daten und saubere Berechtigungen",
          "Nachvollziehbarer Zugriff und sichereres Teilen",
          "KI als Mehrwert, nicht als Risiko"
        ],
        icons: ["⚙️", "✨", "🧊"],
  ...
  fr: {
    ...
    page_portal_body: "Cette page est réservée au portail client. Elle proposera un accès sécurisé aux demandes de support, aux mises à jour de service et à la documentation partagée.",
    page_about_title: "À propos",
    page_about_body: "Nous aidons les micro et petites entreprises à construire une base Microsoft 365 stable et sécurisée. L’objectif est une mise en place pragmatique, des résultats prévisibles et un chemin clair vers la sécurité moderne et l’automatisation.",
    page_contact_title: "Contact",
    page_contact_body: "Si vous souhaitez discuter de votre situation actuelle et définir une base sécurisée, contactez-nous. Nous répondrons avec les prochaines étapes.",
    stages: {
      "stage-basecamp": {
        id: "stage-basecamp",
        chip: "CAMP DE BASE",
      ...
      "stage-discover": {
        ...
        items: [
          "Revue rapide des outils, risques et priorités",
          "Confirmer utilisateurs, appareils, domaine et périmètre",
          "Valider le chemin le plus simple"
        ],
        icons: ["🗂️", "⚠️", "🧠"],
      ...
      "stage-transition": {
        ...
        items: [
          "Migrer e-mail, calendriers et fichiers",
          "Configurer Teams, SharePoint, OneDrive",
          "Peu d’impact, bascule propre"
        ],
        icons: ["✉️", "📁", "👥"],
      ...
      "stage-secure": {
        ...
        items: [
          "MFA imposé pour tous les utilisateurs",
          "Politiques de base appliquées",
          "Partage et permissions plus sûrs"
        ],
        icons: ["🔐", "📜", "🧷"],
      ...
      "stage-ready": {
        ...
        items: [
          "Données centralisées et permissions propres",
          "Accès traçable et partage plus sûr",
          "L’IA comme valeur ajoutée, pas comme risque"
        ],
        icons: ["⚙️", "✨", "🧊"],
